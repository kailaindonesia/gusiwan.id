        ...
        <?php echo form_open('tes_kerjakan/simpan_jawaban','id="form-kerjakan"')?>
    		...
    		<div class="box box-success box-solid">
                ...
                <div class="box-footer">
                    ...
                    <button style="float: right;" class="btn btn-default pull-right" id="btn-hentikan">Tes Selesai</button>
                </div>
            </div><!-- /.box -->
        </form>
    	</div>
                    ...
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="hentikan-centang" name="hentikan-centang" value="1"> Centang dan klik tombol Selesai Tes.
                                    </label>
                                </div>
                            </div>
                        </div>
