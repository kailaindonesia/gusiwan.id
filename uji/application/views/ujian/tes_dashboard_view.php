<div class="container">
    ...
    <section class="content">
        ...
        <div class="box box-success box-solid">
           ...
           <br>
          <h4><strong> Ingin mendaftar KUR (Kredit Usaha Rakyat) ? </strong></h4>
            <a class="btn btn-primary" href="">Lengkapi Dokumen di Profilmu</a>
              <a class="btn btn-success" href="">Kembali ke Gusiwan.id</a>
    </section><!-- /.content -->
