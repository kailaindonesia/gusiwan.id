  ...
  <body class="skin-green layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            ...
            <div class="navbar-header">
              ...
              <img style="padding: 10px 10px;"  class="navbar-brand" src="<?= base_url('img/gusiwann.png');?>"  alt="">
            </div>
      ...
      <footer class="main-footer no-print">
        ...
        <div class="container">
          <strong><strong> <a href="<?php echo site_url(); ?>/manager/" >Log In Operator</a></strong></strong>
        </div><!-- /.container -->
      </footer>
    </div><!-- ./wrapper -->
