  <div class="content">
        ...
        <?php endif; ?>
                   <form action="<?php echo site_url().'/admin/editVendor'?>" method="post" enctype="multipart/form-data">
  ...
  <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="alamat" value="<?php echo $vendor->alamat?>" rows="5"></textarea>
                          </div>
                        </div>
                      </div>
 </div>
