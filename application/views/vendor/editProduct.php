            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                   ...
                   <form action="<?php echo site_url().'/admin/edit'?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="informasi" rows="5" value="<?php echo $product->informasi ?>"></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
