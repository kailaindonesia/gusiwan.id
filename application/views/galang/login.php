		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="<?= base_url('assets/log/images/img-01.png'); ?>" alt="IMG">
				</div>

				<form class="login100-form validate-form" action="<?= site_url('galanglogin/aksi_login'); ?>" method="post">
					<span class="login100-form-title">
						<img src="<?= base_url('assets/log/images/gusiwan.png'); ?>" height="100" alt="IMG">
					</span>
...
<!--===============================================================================================-->
	<script src="<?= base_url('assets/log/vendor/tilt/tilt.jquery.min.js'); ?>"></script>
	<script >
		$('.js-tilt').tilt({
			scale: 1.1
		})
